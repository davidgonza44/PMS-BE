...
export const checkValidRoleIds = async (roleIds : string[]) : Promise<boolean> => {
    const service = new RolesService()
    const valid_roles = await service.findByIds(roleIds) //busca en la bd todos los roles con esos ids
...
export const checkValidDate = function(dateString : string) : boolean {
